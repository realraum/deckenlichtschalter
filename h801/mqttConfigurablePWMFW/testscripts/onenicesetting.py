...
ceiling_clientids_= list(["ceiling%d" % x for x in range(1,9)])
...
def animateSixLightsOnce(client):
    ...
    duration=1000
    msg = {"r":random.randint(0,1000),"g":random.randint(0,700),"b":random.randint(0,700),"cw":0, "ww":random.randint(0,5),"fade":{"duration":duration, "cc":targets[1:]}}

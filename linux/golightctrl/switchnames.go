...
var actionname_map_ map[string]ActionNameHandler = map[string]ActionNameHandler{
	...
	"white50":          ActionNameHandler{pipepattern: &r3events.SetPipeLEDsPattern{Pattern: "white", Arg: 50}, handler: LEDPattern2MQTT},
	"white100":         ActionNameHandler{pipepattern: &r3events.SetPipeLEDsPattern{Pattern: "white", Arg: 100}, handler: LEDPattern2MQTT},
	"red50":            ActionNameHandler{pipepattern: &r3events.SetPipeLEDsPattern{"hue", 0, 50}, handler: LEDPattern2MQTT},
	"green50":          ActionNameHandler{pipepattern: &r3events.SetPipeLEDsPattern{"hue", 60, 50}, handler: LEDPattern2MQTT},
	"blue50":           ActionNameHandler{pipepattern: &r3events.SetPipeLEDsPattern{"hue", 180, 50}, handler: LEDPattern2MQTT},
	"purple50":         ActionNameHandler{pipepattern: &r3events.SetPipeLEDsPattern{"hue", 205, 50}, handler: LEDPattern2MQTT},
	"orange50":         ActionNameHandler{pipepattern: &r3events.SetPipeLEDsPattern{"hue", 20, 50}, handler: LEDPattern2MQTT},
	"huefadeSS30":      ActionNameHandler{pipepattern: &r3events.SetPipeLEDsPattern{"huefade", 1, 30}, handler: LEDPattern2MQTT},
	"huefadeSS70":      ActionNameHandler{pipepattern: &r3events.SetPipeLEDsPattern{"huefade", 1, 70}, handler: LEDPattern2MQTT},
	"huefadeS30":       ActionNameHandler{pipepattern: &r3events.SetPipeLEDsPattern{"huefade", 5, 30}, handler: LEDPattern2MQTT},
	"huefadeS70":       ActionNameHandler{pipepattern: &r3events.SetPipeLEDsPattern{"huefade", 5, 70}, handler: LEDPattern2MQTT},
	"huefadeF30":       ActionNameHandler{pipepattern: &r3events.SetPipeLEDsPattern{"huefade", 200, 30}, handler: LEDPattern2MQTT},
	"huefadeF70":       ActionNameHandler{pipepattern: &r3events.SetPipeLEDsPattern{"huefade", 200, 70}, handler: LEDPattern2MQTT},

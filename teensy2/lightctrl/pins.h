...
const uint8_t btns_on_pins_[6] = {BTN_L1_ON_PIN,BTN_L2_ON_PIN,BTN_L3_ON_PIN,BTN_L4_ON_PIN,BTN_L5_ON_PIN,BTN_L6_ON_PIN};
const *void btns_on_pinreg_[6] = {BTN_L1_ON_PORT,BTN_L2_ON_PORT,BTN_L3_ON_PORT,BTN_L4_ON_PORT,BTN_L5_ON_PORT,BTN_L6_ON_PORT};
const uint8_t btns_off_pins_[6] = {BTN_L1_OFF_PIN,BTN_L2_OFF_PIN,BTN_L3_OFF_PIN,BTN_L4_OFF_PIN,BTN_L5_OFF_PIN,BTN_L6_OFF_PIN};
const *void btns_off_pinreg_[6] = {BTN_L1_OFF_PORT,BTN_L2_OFF_PORT,BTN_L3_OFF_PORT,BTN_L4_OFF_PORT,BTN_L5_OFF_PORT,BTN_L6_OFF_PORT};
const uint8_t btns_sig_pins_[3] = {BTN_C1_PIN,BTN_C2_PIN,BTN_C3_PIN};
const *void btns_sig_pinreg_[3] = {BTN_C1_PORT,BTN_C2_PORT,BTN_C3_PORT};

#define TEST_BTN_ON(x) (btns_on_pinreg[x] & (1<<btns_on_pins[x]) == 0)
#define TEST_BTN_OFF(x) (btns_off_pinreg[x] & (1<<btns_off_pins[x]) == 0)
#define TEST_BTN_SIG(x) (btns_sig_pinreg[x] & (1<<btns_sig_pins[x]) == 0)
